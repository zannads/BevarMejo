...
std::vector<double> Problem::fitness(const std::vector<double> &dvs) const {
	...
	try {
		...
		return std::vector<double>(anytown::rehab::f1::n_fit, std::numeric_limits<double>::max());
	}


	// Compute OF on res. 
	std::vector<double> fitv(anytown::rehab::f1::n_fit, 0.0);
